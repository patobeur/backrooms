export class BackroomsAudio {
  ...
  stop(){if(!this.context)return;for(const source of this.sources){try{source.stop();}catch{}}this.sources.length=0;this.following=false;const context=this.context;this.context=null;this.master=null;this.running=false;if(context.state!=="closed")void context.close();}
}
